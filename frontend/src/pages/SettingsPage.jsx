...
const PREVIEW_MESSAGES = [
  ...
  { id: 2, content: "I'm good eyy! Just working on something.", isSent: true },
];
  ...
  return (
    <div className="h-screen container mx-auto px-4 pt-20 max-w-5xl">
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 gap-2">
          {THEMES.map((t) => {
            ...
            >
              ...
              <span className="text-[11px] font-medium trancate w-full text-center">
                {t.chartAt(0).toUpperCape() + t.slice(1)}
              </span>
            </button>
          })}
        </div>
        ...
        {/* Preview Section */}  
        <h3 className="text-lg fint-semibold mb-3">Preview</h3>
              ...
              <div className="bg-base-100 rounded-xl shadow-sm overflow-hidden">
                ...
                <div className="px-4 py-3 border-b border-base-300 bg-base-100">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="font-medium text-sm">Violet</h3>
